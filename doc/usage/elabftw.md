...
At the moment the unitpackage integration works with **items** exclusively — eLabFTW *experiments* are not yet supported — and each eLabFTW item corresponds to one unitpackage `Entry`.
